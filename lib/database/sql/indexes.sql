...
-- ============================================================================
-- Strategic indexes designed for the Swedish marketplace flipping platform
-- to ensure all queries complete in <100ms as required by CLAUDE.md
-- 
-- CRITICAL PERFORMANCE TARGETS:
-- - Deal detection queries: <100ms
-- - User notification queries: <50ms  
-- - Price database lookups: <100ms
-- - Authentication queries: <25ms
-- ============================================================================
